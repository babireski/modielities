...
Dentre aqueles que compartilharam destas visões opositoras, destaca-se de~\cite{Tymoczko}.
Ainda segundo~\cite{Wilson}, a prova tornou-se mais aceita com o passar do tempo e foi, posteriormente, formalizada em um provador de teoremas por~\cite{Gonthier}.

Dentre provadores de teoremas, podemos destacar provadores automados e provadores interativos.
