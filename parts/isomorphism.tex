    ...
    \begin{proof}
        ...
        \begin{subcase}
            ...
            \begin{fitch}
                ...
                \fa\set{\nec(\nec\varphi^\circ\vee\nec\psi^\circ)}\entails\nec\varphi^\circ\vee\nec\psi^\circ\to\varphi^\medsquare\vee\psi^\medsquare&\refer{or-subst}{L}$\;\set{1,2}$\\
                \fa\set{\nec(\nec\varphi^\circ\vee\nec\psi^\circ)}\entails\varphi^\medsquare\vee\psi^\medsquare&$\hyperref[detachment]{\mathbf{R_2}}\;\set{5,6}$\\
                \fa\entails\nec(\nec\varphi^\circ\vee\nec\psi^\circ)\to\varphi^\medsquare\vee\psi^\medsquare&$\hyperref[deduction]{\mathbf{T_\getrefnumber{deduction}}}\;\set{7}$\\
            \end{fitch}
        \end{subcase}
        ...
        \end{case}
            ...
            \begin{subcase}
                ...
                \begin{fitch}
                    ...
                    \fa\set{\nec(\nec\varphi^\circ\to\psi^\circ),\varphi^\medsquare}\entails\varphi^\medsquare\to\nec\psi^\circ&\refer{comp}{L}$\;\set{2,10}$\\
                    \fa\set{\nec(\nec\varphi^\circ\to\psi^\circ),\varphi^\medsquare}\entails\nec\psi^\circ\to\psi^\medsquare&$\mathbf{H_2}$\\
                    \fa\set{\nec(\nec\varphi^\circ\to\psi^\circ),\varphi^\medsquare}\entails\varphi^\medsquare\to\psi^\medsquare&\refer{comp}{L}$\;\set{11,12}$\\
            ...
            \begin{subcase}
                ...
                \begin{fitch}
                    ...
                    \fa\set{\nec(\varphi^\medsquare\to\psi^\medsquare),\nec\varphi^\circ}\entails\nec\varphi^\circ\to\psi^\medsquare&\refer{comp}{L}$\;\set{2,5}$\\
