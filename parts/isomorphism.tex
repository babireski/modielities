    ...
    \begin{proof}
        ...
        \end{case}
            ...
            \begin{subcase}
                ...
                \begin{fitch}
                    ...
                    \fa\proves\varphi^\medsquare\wedge\psi^\medsquare\to\nec\varphi^\circ\wedge\nec\psi^\circ&$\hyperref[deduction]{\mathbf{T_\getrefnumber{deduction}}}\;\set{12}$\\
                    \fa\proves\nec\varphi^\circ\wedge\nec\psi^\circ\to\nec(\varphi^\circ\wedge\psi^\circ)&\refer{nec-distr}{L}\\
                    \fa\proves\varphi^\medsquare\wedge\psi^\medsquare\to\nec(\varphi^\circ\wedge\psi^\circ)&\refer{comp}{L}$\;\set{13, 14}$\\
                \end{fitch}
            \end{subcase}
        ...
        \begin{subcase}
            ...
            \begin{fitch}
                ...
                \fa\set{\chi}\entails\nec(\nec\varphi^\circ\vee\nec\psi^\circ)&\refer{or-distr}{L}$\;\set{15}$\\
                \fa\entails\varphi^\medsquare\vee\psi^\medsquare\to\nec(\nec\varphi^\circ\vee\nec\psi^\circ)&$\hyperref[deduction]{\mathbf{T_\getrefnumber{deduction}}}\;\set{16}$
            \end{fitch}
        \end{subcase}
