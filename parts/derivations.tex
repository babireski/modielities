\section{Derivações}
    ...
    \begin{theorem}\label{conjunctiondeduction}
        ...
        \begin{proof}
            ...
            \footnotesize
            \begin{fitch}
                \fb\set{\alpha,\beta}\entails\gamma\\
                \fa\set{\alpha}\entails\beta\to\gamma\\
                \fa\entails\alpha\to\beta\to\gamma\\
                \fa\set{\alpha\wedge\beta}\entails\alpha\wedge\beta\\
                \fa\set{\alpha\wedge\beta}\entails\alpha\wedge\beta\to\alpha\\
                \fa\set{\alpha\wedge\beta}\entails\alpha\\
                \fa\set{\alpha\wedge\beta}\entails\alpha\wedge\beta\to\beta\\
                \fa\set{\alpha\wedge\beta}\entails\beta\\
                \fa\set{\alpha\wedge\beta}\entails\alpha\to\beta\to\gamma\\
                \fa\set{\alpha\wedge\beta}\entails\beta\to\gamma\\
                \fa\set{\alpha\wedge\beta}\entails\gamma\\
            \end{fitch}
            \normalsize
            Estando assim demonstrada a proposição.
        \end{proof}
    ...
    \begin{theorem}\label{disjunctiondeduction}
        ...
        \begin{proof}
            ...
            \footnotesize
            \begin{fitch}
                \fb\set{\alpha}\entails\gamma\\
                \fa\set{\beta}\entails\gamma\\
                \fa\entails\alpha\to\gamma\\
                \fa\entails\beta\to\gamma\\
                \fa\set{\alpha\vee\beta}\entails\alpha\to\gamma\\
                \fa\set{\alpha\vee\beta}\entails\beta\to\gamma\\
                \fa\set{\alpha\vee\beta}\entails\alpha\vee\beta\\
                \fa\set{\alpha\vee\beta}\entails(\alpha\to\gamma)\to(\beta\to\gamma)\to\alpha\vee\beta\to\gamma\\
                \fa\set{\alpha\vee\beta}\entails(\beta\to\gamma)\to\alpha\vee\beta\to\gamma\\
                \fa\set{\alpha\vee\beta}\entails\alpha\vee\beta\to\gamma\\
                \fa\set{\alpha\vee\beta}\entails\gamma\\
            \end{fitch}
            \normalsize
            Estando assim demonstrada a proposição.
        \end{proof}
