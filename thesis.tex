...
\begin{document}
    ...
    \chapter{Considerações parciais}
        ...
        \begin{enumerate}
            \item Definir as traduções apresentadas na biblioteca;
            \item Provar os metateoremas apresentados na biblioteca;
            \item Provar que as traduções equivalem na biblioteca;
            \item Provar a correção das traduções na biblioteca.
        \end{enumerate}
        ...
        \begin{table*}[htbp]
            ...
            \begin{tabular}{|c|c|c|c|c|c|c|c|c|}
              ...
              \hline
              \textbf{\small{2}}  &  & \cellcolor{gray} & \cellcolor{gray} & \cellcolor{gray} & \cellcolor{gray} &  & \\
              \hline
